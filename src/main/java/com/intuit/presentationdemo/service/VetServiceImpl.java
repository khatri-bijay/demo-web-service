...
public class VetServiceImpl implements VetService {
    ...
    @Override
    public Set<SpecialtyQuery> getSpecialties() {
        Set<SpecialtyQuery> specialtyQuerySet = specialtyRepository.findAll()
                .parallelStream()
                .map(ModelMapperUtil::toSpecialtyQuery)
                .collect(Collectors.toSet());
        return Collections.unmodifiableSet(specialtyQuerySet);
    }
